...
int main()
{
	...
	int dataArray[10] = { 8,15,23,37,43,58,69,77,85,93 };
				...
				if (option == 3)	// add item
				{
					...
					if (option == 4)	// delete item
					{
						...
						if (option == 5)	// display number of items
							cout << "Number of Items in the binary tree is: " <<  bst.countNodes() << endl;
		
		
						else
							if (option == 6)	// display height
								cout << "The Height of the binary tree is: " << bst.getHeight() << endl;
							else
